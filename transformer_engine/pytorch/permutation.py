        ...
        if ctx.needs_input_grad[0]:
            ...
            if fp8:
                ...
                # blockwise scaling
                    ...
                    is_scaling_aware_transpose = unpermuted_act_grad._is_scaling_aware_transpose
...
def moe_permute_and_pad_with_probs(
    ...
    if torch.equal(tokens_per_expert, target_tokens_per_expert):
        ...
        pad_offsets = pad_offsets.pin_memory()
        pad_offsets = pad_offsets.to(inp.device, non_blocking=True)
